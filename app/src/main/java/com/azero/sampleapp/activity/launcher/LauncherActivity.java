...
import com.azero.sampleapp.manager.AzeroUiManager;
...
public class LauncherActivity extends AppCompatActivity implements AzeroManager.AzeroOSListener {
    ...
    protected void onResume() {
        ...
        isForeground = true;
        AzeroUiManager.getInstance().registerUIListener(mUIListenerImpl);
    }
    ...
    protected void onPause() {
        ...
        isForeground = false;
        AzeroUiManager.getInstance().unRegisterUIListener(mUIListenerImpl);
    }
